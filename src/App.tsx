...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 text-gray-800">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-primary via-blue-800 to-blue-900 text-white py-24">
        <div className="absolute inset-0 opacity-15">
          <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(circle_at_30%_20%,_rgba(0,177,167,0.2)_0%,_transparent_50%)]"></div>
          <div className="absolute bottom-0 right-0 w-full h-full bg-[radial-gradient(circle_at_70%_80%,_rgba(42,58,92,0.3)_0%,_transparent_50%)]"></div>
        </div>

        {/* Animated geometric elements */}
        <div className="absolute inset-0">
          <div className="absolute top-1/4 left-1/4 w-16 h-16 border border-white border-opacity-20 rounded-lg rotate-45 animate-pulse"></div>
          <div className="absolute top-3/4 right-1/4 w-12 h-12 border border-white border-opacity-10 rounded-full animate-ping"></div>
          <div className="absolute top-1/2 left-1/3 w-8 h-8 bg-secondary opacity-20 rounded-lg rotate-12 animate-bounce"></div>
          <div className="absolute bottom-1/3 right-1/3 w-10 h-10 border border-white border-opacity-15 rounded-lg rotate-45 animate-pulse"></div>
          <div className="absolute top-1/6 right-1/6 w-6 h-6 bg-white opacity-10 rounded-full animate-ping"></div>
        </div>

        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          <div className="mb-6">
            <div className="inline-block p-4 bg-white bg-opacity-10 rounded-2xl backdrop-blur-sm border border-white border-opacity-20 mb-8">
              <h1 className="text-6xl md:text-8xl font-bold bg-gradient-to-r from-white via-blue-100 to-secondary bg-clip-text text-transparent">
                Architect
              </h1>
            </div>
          </div>
          ...
          <div className="flex justify-center mb-10">
            <div className="bg-gradient-to-r from-secondary to-teal-400 rounded-full px-8 py-3 text-white font-semibold shadow-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
            <div className="text-center">
              <div className="w-16 h-16 bg-gradient-to-r from-secondary to-teal-400 rounded-xl flex items-center justify-center mx-auto mb-4 shadow-lg">
                <span className="text-2xl">🤖</span>
              </div>
              <h3 className="text-lg font-semibold mb-2">AI Agents</h3>
              <p className="text-blue-200 text-sm">Intelligent analysis of your business ideas</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-gradient-to-r from-secondary to-teal-400 rounded-xl flex items-center justify-center mx-auto mb-4 shadow-lg">
                <span className="text-2xl">🚀</span>
              </div>
              <h3 className="text-lg font-semibold mb-2">Instant Planning</h3>
              <p className="text-blue-200 text-sm">Comprehensive implementation plans in seconds</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-gradient-to-r from-secondary to-teal-400 rounded-xl flex items-center justify-center mx-auto mb-4 shadow-lg">
                <span className="text-2xl">🏢</span>
              ...
              <p className="text-blue-200 text-sm">Scalable solutions for business requirements</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
          ...
          <div className="max-w-2xl mx-auto">
            <div className="relative">
              ...
              <button
                ...
                className="mt-4 px-8 py-3 bg-gradient-to-r from-secondary to-teal-500 text-white rounded-lg font-semibold hover:from-teal-500 hover:to-teal-600 disabled:opacity-50 disabled:cursor-not-allowed transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl hover:shadow-secondary/30"
              >
                {isAnalyzing ? (
        ...
        {result && (
          <section className="mb-20">
            <div className="bg-white bg-gradient-to-br from-white to-blue-50 rounded-2xl shadow-2xl p-8 border border-gray-100">
              ...
              >
                {USE_CASES.map((useCase, index) => (
                  <div key={index} className="w-full flex-shrink-0 px-4">
                    <div className="bg-white bg-gradient-to-br from-white to-blue-50 rounded-xl shadow-xl p-8 text-center border border-gray-200 hover:shadow-2xl transition-all duration-300">
        ...
        <section className="mb-20">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className={`bg-white bg-gradient-to-br from-white to-blue-50 rounded-xl shadow-lg p-6 border-2 ${plan.popular ? 'border-secondary border-4' : 'border-gray-200'}`}>
                {plan.popular && (
